...
function DialogDeleteAccessory({children,id}: {children: React.ReactNode}) {
  ...
  return (
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <DialogFooter>
              <Button type="submit" className="bg-red-600" onClick={handleDelete}>Supprimer le produit</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
