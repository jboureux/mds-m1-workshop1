...
const InfoCard = () => {
  const tabsTriggerClasses = `
        text-xl ${fonts.bebasNeue.className}
      ...
      <Card className="lg:m-24 m-8">
        <CardHeader className="h-fit">
          <TabsList className="h-fit bg-white justify-start flex flex-wrap">
            <TabsTrigger value="description" className={tabsTriggerClasses}>
              Description
            </TabsTrigger>
            <TabsTrigger value="deposit" className={tabsTriggerClasses}>
              Acompte
            </TabsTrigger>
            <TabsTrigger value="bring-device" className={tabsTriggerClasses}>
              Fournir une console
            </TabsTrigger>
            <TabsTrigger value="shipping" className={tabsTriggerClasses}>
              Délais et expédition
            </TabsTrigger>
            <TabsTrigger value="guarantee" className={tabsTriggerClasses}>
              Garantie
            </TabsTrigger>
          </TabsList>
        </CardHeader>
